...
export default function DesignDetails2() {
  ...
  useEffect(() => {
    ...
    //   try {
    //     // Requisição para buscar as reviews associadas ao produto
    //     const reviewsResponse = await axios.get(
    //       `http://${IP_URL}:3000/reviews/${productId}`
    //     );
    //     setReviews(reviewsResponse.data); // Armazena as reviews no estado
    //   } catch (error) {
