...
const data = [
  { id: 1, image: require('../assets/images/Drinks/Caipirinha.png'), characteristic: 'Caipirinha', icon: require('../assets/images/HeartNaked.png') },
  { id: 2, image: require('../assets/images/Drinks/MoscowMule.png'), characteristic: 'Moscow Mule', icon: require('../assets/images/HeartNaked.png') },
  { id: 3, image: require('../assets/images/Drinks/Sangria.png'), characteristic: 'Sangria', icon: require('../assets/images/HeartNaked.png') },
  { id: 4,image: require('../assets/images/Drinks/Margarita.png'), characteristic: 'Margarita', icon: require('../assets/images/HeartNaked.png') },
  { id: 5,image: require('../assets/images/Drinks/VirginOnTheBeach.png'), characteristic: 'Virgin On The Beach', icon: require('../assets/images/HeartNaked.png') },
  { id: 6,image: require('../assets/images/Drinks/Mojito.png'), characteristic: 'Mojito', icon: require('../assets/images/HeartNaked.png') },
  { id: 7,image: require('../assets/images/Drinks/PinaColada.png'), characteristic: 'Pina Colada', icon: require('../assets/images/HeartNaked.png') },
  { id: 8,image: require('../assets/images/Drinks/BlueHawaiian.png'), characteristic: 'Blue Hawaiian', icon: require('../assets/images/HeartNaked.png') },
  { id: 9,image: require('../assets/images/Drinks/Flower.png'), characteristic: 'Flower', icon: require('../assets/images/HeartNaked.png') },
  { id: 10,image: require('../assets/images/Drinks/WattermelonSlushie.png'), characteristic: 'Wattermelon Slushie', icon: require('../assets/images/HeartNaked.png') },
